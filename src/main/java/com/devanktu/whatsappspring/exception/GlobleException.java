package com.devanktu.whatsappspring.exception;
...
public class GlobleException {
    ...
    public ResponseEntity<ErrorDetail> MethodArgumentNotValiExceptionHandler(MethodArgumentNotValidException me){
